...
$(document).ready(function(){
    $("#btn-refresh").click(function (e){
        var data = {
            ...
            "scope": "userinfo node file"
        }

        $.post(baseUrl + '/oauth2/RefreshToken', data, function (d){
    ...
    $('#btn-authorize').click(function (e){
        ...
        $.post(baseUrl + '/oauth2/authorize/token', data, function (d){
    ...
    $('#btn-resource').click(function (e){
        ...
        $.post(baseUrl + '/oauth2/resource', data, function (d){
    ...
    $('#btn-resource-limit').click(function (e){
        ...
        $.post(baseUrl + '/oauth2/resource/limit', data, function (d){
            console.log("Get Authorize => ", d);
            $('#return-resource').html(JSON.stringify(d));
        },"json");      
    });
    ...
    $('#btn-PasswordCredentials').click(function (e){
        ...
        $.post(baseUrl + '/oauth2/PasswordCredentials', data, function (d){
    ...
    $("#btn-ClientCredentials").click(function (e){
        ...
        $.post(baseUrl + '/oauth2/ClientCredentials', data, function (d){
            //d = d.JSON.parse(d);
